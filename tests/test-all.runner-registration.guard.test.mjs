...
assert.match(source, /run\("node", \["tests\/poker-celebration-preview\.unit\.test\.mjs"\],/, "runner should include poker celebration preview identity regression test");
...
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-ws-join-smoke\.behavior\.test\.mjs"\],/, "runner should not include removed classic poker-ui ws join smoke test");
...
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-ws-write-path\.guard\.test\.mjs"\],/, "runner should not include removed classic poker-ui ws write-path guard test");
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-ws-leave-smoke\.behavior\.test\.mjs"\],/, "runner should not include removed classic poker-ui ws leave smoke test");
...
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-no-heartbeat\.guard\.test\.mjs"\],/, "runner should not include removed classic poker-ui no-heartbeat guard test");
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-ws-live-state-page\.behavior\.test\.mjs"\],/, "runner should not include removed classic poker-ui ws live-state page behavior test");
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-deadline-nudge\.guard\.test\.mjs"\],/, "runner should not include removed classic poker-ui deadline nudge guard test");
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-stopPolling-clears-nudge\.guard\.test\.mjs"\],/, "runner should not include removed classic poker-ui stopPolling clears nudge guard test");
...
assert.doesNotMatch(source, /run\("node", \["tests\/poker-ui-requestid-retry\.guard\.test\.mjs"\],/, "runner should not include removed classic poker ui requestid retry guard test");
