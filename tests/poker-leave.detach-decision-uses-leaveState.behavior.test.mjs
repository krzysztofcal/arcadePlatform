...
const handler = loadPokerHandler("netlify/functions/poker-leave.mjs", {
  ...
  isValidUuid: () => true,
  normalizeRequestId: () => ({ ok: true, value: "leave-snapshot" }),
...
const response = await handler({
  ...
  body: JSON.stringify({ tableId, requestId: "leave-snapshot", includeState: true }),
});
...
console.log("poker-leave detach decision uses leaveState behavior test passed");
