...
- [ ] T001 Zapisać w specs/796-bot-quarantine/quickstart.md niezależny wybór #1018 vs #869, osobne zlecenie implementacji i zatwierdzony demand-driven autorefill bez lifetime cap. Gotowe: jawne review, brak automatycznego startu. FR-007/013/014,SC-004.

## Phase 2 — Foundational

- [ ] T002 Po T001 dodać addytywną supabase/migrations dla chips_accounts i jednej tabeli receipt z data-model.md: access NOT NULL NORMAL/RESTRICTED; RESTRICTED komplet metadanych; receipt funding_key PK,tier IN(100,500),funding_amount>0,0<=mint_amount<=funding_amount,source/table UUID,funding_transaction_id UNIQUE,mint_transaction_id UNIQUE nullable iff mint_amount=0,hash NOT NULL bez cascade hot-ledger FK. Sprawdzić rzeczywiste grants/RLS i odebrać klientowi zapis policy/access. Gotowe: brak seed/MINT i masowej klasyfikacji, istniejący500 seed nietknięty; przed publikacją jawny zamiar DB Stage Apply PR/shared Stage, applied forward-only. FR-001/007/008/013.
- [ ] T003 Po T002 sprawdzić i ujednolicić prelock w dotkniętych shared/poker-domain/join.mjs, ws-server/poker/persistence/persisted-state-writer.mjs oraz obu chips-ledger.mjs: table/state/membership przed uporządkowanym zbiorem account IDs; composite refill w tym samym table/state/account tx co funding. Gotowe: żadnej deklaracji nieistniejącego order w CTE; unknown/deadlock rollback, payout bez nowego gate. FR-003/006/008/009.
...
- [ ] T014 [US3] Po T013 dodać shared/poker-domain/bot-refill.mjs::postBotFundingWithRefill i narrow general-ledger entry w netlify/functions/_shared/chips-ledger.mjs. Gotowe: gate i locked real plan,original funding key replay,exact D=max(0,F−B),MINT+TABLE_BUY_IN+receipt jeden tx/savepoint,brak counter/lifetime/window,samodzielnego mint i metadata/env bypass. WS adapter pozostaje existing buy-in. FR-007/008/009,SC-003.
...
- [ ] T016 [US3] Po T014 sprawdzić scripts/ops/_shared/chips-ledger-retention-cycle.mjs i chips-ledger-archive-prune.mjs względem data-model.md. Gotowe: receipt funding_key i registry/hash zachowane,legacy replay bez ponownego mint,hot-ledger prune bez utraty tożsamości. Preferować dowód zgodności bez zmiany runtime;bez drugiego archiwizatora. FR-008,SC-003.

## Phase 6 — Cross-cutting / handoff

- [ ] T017 Po T007/T012/T015/T016 dodać jeden tests/chips/poker-bot-quarantine.transaction.test.mjs z istniejącym postgres/node:test i lokalnym odizolowanym DB: race NORMAL/RESTRICTED empty JOIN, cross-table classification/funding, dwa NORMAL funding na shared source,restricted table zero refill obok NORMAL,mint+funding rollback/retry/unknown commit, denial+cashout. Gotowe:2połączenia, bariery bez sleeps, odmowa Stage/Production target; zero mixed/double mint/payout i funded-state rollback. FR-001–010/012,SC-001–003.
