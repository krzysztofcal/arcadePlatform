...
- **FR-002**: Leniwe wykrycie przy authenticated human Create,nowym poker JOIN i przed dodatnim funding wszystkich aktualnych seated humans; brak skanera platformy i pomiaru historycznych peak balances. Odczyt przed debitem buy-in.
