...
Normatywne bezpieczniki D.3 opisuje plan.md. WS ocenia cały rejestr live w pamięci; limit32 dotyczy wyłącznie pasujących ofert wysyłanych do lobby. Jeden in-flight refresh/konto, brak viewer×table SQL,2 admission/1create. Create po click wymaga kompletnego aktualnego no-offer z całego registry i pełnego preflight; failure/stale/timeout/niepełny proof nigdy nie oznacza braku ofert. T038 waliduje koszty. D.3 obciążenia nie jest D3 jednorazowej alokacji.
