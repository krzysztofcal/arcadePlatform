...
## Otwarte M1 — dostępność find-or-create przy dużym zbiorze

FR-012/D.1 pozostaje zatwierdzonym wymaganiem. Obecny bounded projekt nie gwarantuje create po pełnej kontynuacji ponad100 residual kandydatów: świeża kompletna weryfikacja może nigdy nie zmieścić się w request. FR-034 wymaga ujawnienia tego jako terminal search_capacity_exceeded bez create, nie chwilowego wait; nie jest to zatwierdzone odstępstwo od FR-012. Właściciel musi zaakceptować ograniczenie dostępności albo autoryzować osobny projekt spójnego dowodu wielożądaniowego wyszukania (contracts §M1). Do decyzji cały plan nie jest gotowy do akceptacji/implementacji. Fundamentalny scenariusz150 bez zgodnego stołu odróżnia tę lukę od zwykłego braku środków; dwa progress tej samej próby i replay nie mogą kolidować w UNIQUE ani przesuwać kursora dwukrotnie.
