...
Admin listTables/loadTableDetails używają requireAdminUser i persisted inventory; admin-ops loadPersistedTableSnapshots ma jawny SELECT bez nowych policy pól, więc trzeba rozszerzyć także ten helper i createTableMeta. UI pozostaje js/admin-page.js. #789 sprawdzone przez GitHub: OPEN; historyczne CLOSED w treści #869 pozostawione w źródłowej kopii, nie jako aktualny fakt. D.2 nie buduje spectatora. Brak nowych tabel/pól DB z tej korekty.
