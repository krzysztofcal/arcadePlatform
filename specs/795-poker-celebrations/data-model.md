...
- Active FX: demo flag, table/hand, end timestamp, exit/deemphasis state and optional anchor identity; one overlay, one timer at a time, no queue. Hero 1600 ms plus a 400 ms decorative exit.
