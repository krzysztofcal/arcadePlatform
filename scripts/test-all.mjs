...
run("node", ["tests/poker-ui-ws-live-state-page.behavior.test.mjs"], "poker-ui-ws-live-state-page-behavior");
run("node", ["tests/poker-ui-deadline-nudge.guard.test.mjs"], "poker-ui-deadline-nudge-guard");
run("node", ["tests/poker-ui-stopPolling-clears-nudge.guard.test.mjs"], "poker-ui-stopPolling-clears-nudge-guard");
