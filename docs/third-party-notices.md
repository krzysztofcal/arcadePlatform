...
| Block Stacker (derived from Canvas Tetris) | `games-open/tetris` | [Dionysis Zindros](https://github.com/dionyziz/canvas-tetris) | MIT — `public/games/tetris/LICENSE` | retain copyright and MIT text |
