...
| Game ID: tetris (Block Stacker compatibility alias) | games-open/tetris/index.html:197 | `sha256-Rnt3+nPKWPiw/qrDaU3o++VVHxBSkZ+c3jPI2wHLOOk=` |
...
| Debug copy logs 1 | Debug popup window (generated by debug.js) | `sha256-jHRymoWpX/G1UN93sLvOZ0jns2+9joiABzpMmVTyQaM=` |
| Debug copy logs 2 | Debug popup window (variation) | `sha256-m1HaEnDAmXYsLGVIkrnznqN0XzWa2+18yq52aZc2uMU=` |
