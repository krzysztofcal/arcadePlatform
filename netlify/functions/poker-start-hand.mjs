...
const RETIRED_RESPONSE = {
  ok: false,
  error: "start_hand_http_retired",
  message: "Starting hands is WS-only. This legacy HTTP endpoint is retired and non-authoritative."
};
...
export async function handler(event) {
  ...
  klog("poker_start_hand_http_retired", {
    method,
