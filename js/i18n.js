...
(function(){
  const dict = {
    ...
    publicAvatarUploading: { en: 'Uploading and processing avatar...', pl: 'Przesyłanie i przetwarzanie awatara...' },
    publicAvatarRemoving: { en: 'Restoring default avatar...', pl: 'Przywracanie domyślnego awatara...' },
    publicAvatarUpdated: { en: 'Avatar updated.', pl: 'Awatar został zaktualizowany.' },
