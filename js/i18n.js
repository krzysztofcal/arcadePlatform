...
(function(){
  const dict = {
    ...
    accountPokerTables: { en: 'Poker tables', pl: 'Stoły pokerowe' },
    accountPokerUnavailable: { en: 'Poker tables are unavailable right now. Please try again.', pl: 'Stoły pokerowe są teraz niedostępne. Spróbuj ponownie.' },
    accountPokerEmpty: { en: 'You are not currently in a poker table.', pl: 'Nie jesteś obecnie przy żadnym stole pokerowym.' },
    accountPokerSeat: { en: 'Seat {seat}', pl: 'Miejsce {seat}' },
    accountPokerLeaving: { en: 'Leaving; waiting for hand completion and cash-out.', pl: 'Opuszczanie stołu; oczekiwanie na zakończenie rozdania i wypłatę.' },
...
homeBonusLoadError: { en: 'Could not load available bonuses.', pl: 'Nie udało się pobrać dostępnych bonusów.' },
    ...
    pokerReaction_thinking: { en: 'Thinking...', pl: 'Myślę...' },
    pokerReaction_haha: { en: 'Haha', pl: 'Haha' },
    pokerReaction_wow: { en: 'Wow!', pl: 'Wow!' },
    pokerReaction_bad_beat: { en: 'Bad beat', pl: 'Pechowe rozdanie' },
    pokerReaction_nice_bluff: { en: 'Nice bluff!', pl: 'Niezły blef!' },
    pokerReaction_good_luck: { en: 'Good luck', pl: 'Powodzenia' },
    pokerReaction_thanks: { en: 'Thanks', pl: 'Dzięki' },
    pokerReaction_cheers: { en: 'Cheers!', pl: 'Na zdrowie!' },
    pokerReaction_gg: { en: 'GG!', pl: 'GG!' },
    pokerReaction_hurry_up: { en: 'Please, hurry up!', pl: 'Proszę, szybciej!' },
    pokerReaction_you_are_bluffing: { en: 'You are bluffing!', pl: 'Blefujesz!' },
    pokerReaction_i_was_bluffing: { en: 'I was bluffing!', pl: 'To był blef!' },
    pokerReaction_lucky: { en: 'Lucky!', pl: 'Ale szczęście!' },
    pokerReaction_congrats: { en: 'Congrats!', pl: 'Gratulacje!' },
    pokerReaction_not_this_time: { en: 'Not this time.', pl: 'Tym razem nie.' },
    pokerReaction_ambient_hmm: { en: 'Hmm...', pl: 'Hmm...' },
    pokerReaction_ambient_interesting: { en: 'Interesting...', pl: 'Interesujące...' },
    pokerReaction_ambient_lets_see: { en: "Let's see...", pl: 'Zobaczymy...' },
    pokerReaction_ambient_well_see: { en: "We'll see.", pl: 'Zobaczymy.' },
    pokerReaction_ambient_watching: { en: "I'm watching.", pl: 'Obserwuję.' },
    pokerReaction_ambient_good_move: { en: 'Good move.', pl: 'Dobry ruch.' },
    pokerReaction_ambient_bold: { en: 'Bold.', pl: 'Odważnie.' },
    pokerReaction_ambient_nice: { en: 'Nice.', pl: 'Nieźle.' },
    pokerReaction_ambient_tough_one: { en: 'Tough one.', pl: 'Trudne.' },
    pokerReaction_ambient_here_we_go: { en: 'Here we go!', pl: 'Zaczynamy!' },
    pokerReaction_ambient_your_move: { en: 'Your move.', pl: 'Twój ruch.' },
    pokerReaction_ambient_lets_play: { en: "Let's play.", pl: 'Zagrajmy.' },
