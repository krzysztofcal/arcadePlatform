  ...
  function renderPokerMaintenance(){
    ...
    if (!snapshot){
      ...
      nodes.opsMaintenance.innerHTML = [
        ...
        renderKvRow("Backlog ordinary rows", cleanup.backlog && cleanup.backlog.available ? cleanup.backlog.ordinaryActionRows : "unavailable"),
        renderKvRow("Backlog HAND_SETTLED", cleanup.backlog && cleanup.backlog.available ? cleanup.backlog.handSettledRows : "unavailable"),
